...
function ShareBtns ({ lives }: Props) {
  ...
  const pageTittle = lives > 0 ? encodeURI(`¡He llegado a la cerveza y me han sobrado ${lives} vidas! ¿Puedes hacerlo mejor?`) : encodeURI('¡No he conseguido llegar a la botella! ¿Puedes hacerlo mejor?')
  const pageTittleAlt = lives > 0 ? `¡He llegado a la cerveza y me han sobrado ${lives} vidas! ¿Puedes hacerlo mejor?` : '¡No he conseguido llegar a la botella! ¿Puedes hacerlo mejor?'
